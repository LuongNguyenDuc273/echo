<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SanPhamTimKiem.aspx.cs" Inherits="echo.echo.SanPhamTimKiem" %>
...
<body>
    <form id="formsanpham" method="post" runat="server">
        ...
        <!-- SP LIST -->
        <section id="sp-list" class="section-p1">
            <h1 id="thongbao" name="thongbao" runat="server">SẢN PHẨM TÌM KIẾM</h1>
