<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SanPhamChuot.aspx.cs" Inherits="echo.echo.SanPhamChuot" %>
    ...
    <form id="formsanpham" method="post" runat="server">
        ...
        <section id="sp-category">
            ...
            <div class="category-button">
                <button type="button" class="button"  onclick="location.href='SanPham.aspx';">
